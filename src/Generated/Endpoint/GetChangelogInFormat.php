...
class GetChangelogInFormat extends \Datenkraft\Backbone\Client\AccessManagementApi\Generated\Runtime\Client\BaseEndpoint implements \Datenkraft\Backbone\Client\AccessManagementApi\Generated\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (404 === $status) {
            throw new \Datenkraft\Backbone\Client\AccessManagementApi\Generated\Exception\GetChangelogInFormatNotFoundException($response);
        }
        if (400 === $status) {
            throw new \Datenkraft\Backbone\Client\AccessManagementApi\Generated\Exception\GetChangelogInFormatBadRequestException($response);
        }
