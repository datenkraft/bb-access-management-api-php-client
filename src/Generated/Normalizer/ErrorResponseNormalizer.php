...
class ErrorResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Datenkraft\Backbone\Client\AccessManagementApi\Generated\Model\ErrorResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Datenkraft\Backbone\Client\AccessManagementApi\Generated\Model\ErrorResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('errors', $data)) {
            ...
            foreach ($data['errors'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Datenkraft\Backbone\Client\AccessManagementApi\Generated\Model\Error::class, 'json', $context);
            }
    ...
    {
        return [\Datenkraft\Backbone\Client\AccessManagementApi\Generated\Model\ErrorResponse::class => false];
    }
}