...
class InformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Datenkraft\\Backbone\\Client\\AccessManagementApi\\Generated\\Model\\Information';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Datenkraft\\Backbone\\Client\\AccessManagementApi\\Generated\\Model\\Information';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('references', $data)) {
            ...
            foreach ($data['references'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Datenkraft\\Backbone\\Client\\AccessManagementApi\\Generated\\Model\\ErrorReferencesItem', 'json', $context);
            }
